...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        point1 = Point(self.start.x + other_line.start.x, self.start.y +
                       other_line.start.y)
        point2 = Point (self.end.x + other_line.end.x, self.end.y +
                        other_line.end.y)
    ...
    def midpoint(self):
        ...
        x_point = (self.start.x + self.end.x)/2
        y_point = (self.start.y + self.end.y)/2
    ...
    def is_parallel(self, line2):
        ...
        slop_1 = self.slope()
        slop_2 = line2.slope()
        if round(slop_1,12) == round(slop_2,12):
            return True
        else:
            return False
    ...
    def reset(self):
        ...
        self.start = self.always_start
        self.end = self.always_end
