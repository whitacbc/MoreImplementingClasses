...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.intersectoin_center = intersection_center
        self.width = width
        self.height = height
        self.letter_thickness = letter_thickness


        hrad1 = letter_thickness/2
        hrad2 = letter_thickness/2
        vrad1 = width/2
        vrad2 = width/2
        hcorner1 = rg.Point(intersection_center.x - vrad1 ,
                            intersection_center.y
                            - hrad1,)
        hcorner2 = rg.Point(intersection_center.x + vrad1,
                            intersection_center.y
                            + hrad1)
        vcorner1 = rg.Point(intersection_center.x-hrad1,
                            intersection_center.y-hrad2)

        vcorner2 = rg.Point(intersection_center.x + hrad1,
                            intersection_center.y-hrad2 + height)
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        rectangle = CapitalT(self.intersectoin_center,self.width,self.height,
